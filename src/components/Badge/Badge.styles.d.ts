...
export type BadgeConfig = {
    appearance?: Partial<Record<BadgeAppearance, Partial<Record<'high' | 'medium' | 'low', BaseProps>>>>;
    intent?: Partial<Record<BadgeIntent, Partial<Record<'high' | 'medium' | 'low', BaseProps>>>>;
    hasLabel?: BaseProps;
    innerElements?: {
        label?: BaseProps;
