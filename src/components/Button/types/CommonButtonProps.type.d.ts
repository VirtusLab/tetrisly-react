...
type ButtonHTMLProps = Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'disabled' | 'color'>;
type DropdownOrAfterIcon = Or<{
    afterIcon?: IconName<20>;
}, {
    hasDropdownIndicator?: boolean;
}>;
export type CommonButtonProps = CommonProps & ButtonHTMLProps & DropdownOrAfterIcon;
export {};
