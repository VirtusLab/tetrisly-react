...
declare const meta: {
    ...
    } & Omit<import("react").ButtonHTMLAttributes<HTMLButtonElement>, "color" | "disabled"> & import("@xstyled/system").MarginProps<import("@xstyled/system").Theme>) => import("react/jsx-runtime").JSX.Element;
    tags: string[];
    argTypes: {
        variant: {
            description: string;
