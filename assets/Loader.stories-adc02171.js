import{j as _}from"./TetrislyProvider-07235cd3.js";import{r as c}from"./index-76fb7be0.js";import{L as i}from"./Loader-a3560852.js";import"./_commonjsHelpers-de833af9.js";import"./mergeConfigWithCutom-789678df.js";const F={title:"Components/Loader",component:i,tags:["autodocs"]},r={args:{shape:"circle"}},e={args:{shape:"bar"}},s=()=>{const[p,u]=c.useState(0);return c.useEffect(()=>{const l=setInterval(()=>u(d=>(d+.01)%1),50);return()=>clearInterval(l)},[]),_.jsx(i,{shape:"circle",progress:p})},a=()=>{const[p,u]=c.useState(0);return c.useEffect(()=>{const l=setInterval(()=>u(d=>(d+.01)%1),50);return()=>clearInterval(l)},[]),_.jsx(i,{shape:"bar",progress:p})},t={args:{shape:"circle",appearance:"white"},parameters:{backgrounds:{default:"dark"}}},n={args:{shape:"bar",appearance:"inverted"},parameters:{backgrounds:{default:"dark"}}},o={args:{shape:"circle",appearance:"greyscale"}};var m,g,f;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    shape: 'circle'
  }
...
//# sourceMappingURL=Loader.stories-adc02171.js.map
